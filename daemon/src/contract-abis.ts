...
const CREATURE_STATE_COMPONENTS = [
  ...
  { name: "lastLifeTickAt", type: "uint40" },
  { name: "stage", type: "uint8" },
  { name: "hibernating", type: "bool" },
  { name: "aggression", type: "uint16" },
  { name: "curiosity", type: "uint16" },
  { name: "sociability", type: "uint16" },
  { name: "greed", type: "uint16" },
  { name: "stability", type: "uint16" },
  { name: "chaos", type: "uint16" },
  { name: "adaptability", type: "uint16" },
  { name: "memoryBias", type: "uint16" },
  { name: "energy", type: "uint16" },
  { name: "mood", type: "uint16" },
